    ...
    def invoke(self, prompt, temperature=0.7):
        ...
        for attempt in range(max_retries):  
            try: 
                ...
                # Success!
                # Cool down to avoid hitting TPM (Tokens Per Minute) limit immediately on next call
                # Groq Free Tier limit is ~12k TPM. 
                print("Step complete. Pausing 15s to respect Groq API rate limits...")
                time.sleep(15) 
